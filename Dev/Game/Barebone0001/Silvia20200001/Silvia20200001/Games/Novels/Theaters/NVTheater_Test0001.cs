		...
		public override void Invoke(string command, string[] arguments)
		{
			...
			else if (command == "キャラクタ位置")
			{
				...
				switch (arguments[c++])
				{
					...
					case "左": x = 250.0; y = 300.0; z = 1.0; break;
					case "右": x = 710.0; y = 300.0; z = 1.0; break;
					case "右端": x = 860.0; y = 300.0; z = 1.0; break;

					case "左端(BU)": x = 100.0; y = 500.0; z = 2.0; break;
					case "左(BU)": x = 250.0; y = 500.0; z = 2.0; break;
					case "右(BU)": x = 710.0; y = 500.0; z = 2.0; break;
			...
			else if (command == "キャラクタ画像")
			{
				...
				switch (arguments[c++])
				{
					case "退場": picture = Pictures.TransparentBox; break;
