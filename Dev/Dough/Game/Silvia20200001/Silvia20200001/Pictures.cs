...
namespace Charlotte
{
	public static class Pictures
	{
		...
		public static Picture 弦巻マキ_普 = new Picture(@"Picture\からい\maki01.png");
		public static Picture 弦巻マキ_怒 = new Picture(@"Picture\からい\maki02.png");
		public static Picture 結月ゆかり_普 = new Picture(@"Picture\からい\yukari02.png");
		public static Picture 結月ゆかり_喜 = new Picture(@"Picture\からい\yukari03.png");
